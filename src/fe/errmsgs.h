...
//     cstr msg;
//     cstr advice;
//     ParserErr(PrsErr err, cstr msg, cstr advice) : err(err), msg(msg), advice(advice)
//     {
//     }
// };
...
//     ParserErr(PrsErr::ImportStringExpect, "Import statement requires a cstr path",
//               "Add a path as a cstr literal in the import statement"),
...
//               "Add an open curly brackets '}'"),
//     ParserErr(PrsErr::ImportId, "Import aliased cstr requires an Id as alias",
