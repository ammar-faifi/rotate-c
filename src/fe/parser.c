...
//         ast->imports.append(AstImport(alias, str));
//         log_debug("added an aliased import");
//     }
//     else
//     {
//         ast->imports.append(AstImport(str));
...
//     ast->gl_variables.append(AstGlVar(id, t, val));
...
// {
//     ast->literals.append(lit);
//     ast->expressions.append(Expr(LitIdx++, ExprType::Literal));
//     return ExprIndex++;
// }
...
// {
//     ast->arr_exprs.append(a);
//     ast->expressions.append(Expr(ArrayExprIdx++, ExprType::ArrayLiteral));
//     return ExprIndex++;
// }
